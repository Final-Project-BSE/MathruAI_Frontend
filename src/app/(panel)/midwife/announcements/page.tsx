...
import { AnnouncementDto } from "../../../api/announcement/types";
...
export default function MidwifeAnnouncementPage({ token }: Props) {
  ...
  const loadAnnouncements = async () => {
    ...
    try {
      setLoading(true);
      const data = await announcementApi.getAllAnnouncements(token);
