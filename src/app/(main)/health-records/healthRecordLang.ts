...
> = {
  ...
  si: {
    title: "සෞඛ්‍ය ලේඛන",
    subtitle: "ඔබේ සෞඛ්‍ය ලේඛන කාණ්ඩ අනුව බලන්න සහ කළමනාකරණය කරන්න",
    totalCategories: "මුළු කාණ්ඩ",
    totalRecords: "මුළු ලේඛන",
    lastUpdated: "අවසන් යාවත්කාලීන කිරීම",
    today: "අද",
    unauthorized: "අවසර නැත. කරුණාකර පුරනය වන්න.",
    loadCategoriesError: "සෞඛ්‍ය ලේඛන කාණ්ඩ පූරණය කළ නොහැකි විය.",
    loadRecordsError: "සෞඛ්‍ය ලේඛන පූරණය කළ නොහැකි විය.",
    loadRecordDetailsError: "ලේඛන විස්තර පූරණය කළ නොහැකි විය.",
    saveRecordError: "ලේඛනය සුරැකීමට නොහැකි විය. නැවත උත්සාහ කරන්න.",
    deleteRecordError: "ලේඛනය මකා දැමීමට නොහැකි විය.",
    updateRecordError: "ලේඛනය යාවත්කාලීන කිරීමට නොහැකි විය. නැවත උත්සාහ කරන්න.",
    recordNotFound: "ලේඛනය සොයාගත නොහැක",
    error: "දෝෂය",
    records: "ලේඛන",
    latest: "නවතම",
    addRecord: "ලේඛනයක් එක් කරන්න",
    add: "එක් කරන්න",
    noRecordsYet: "තවම ලේඛන නැත",
    noRecordsHelp: '"ලේඛනයක් එක් කරන්න" ක්ලික් කර ඔබේ පළමු ලේඛනය එක් කරන්න.',
    record: "ලේඛනය",
    recordsPlural: "ලේඛන",
    file: "ගොනුව",
    files: "ගොනු",
    ...
    images: "පින්තූර",
    documents: "ලේඛන",
    failedToLoad: "පූරණය නිෂ්ඵලය",
    preview: "පෙරදසුන",
    healthRecordsBreadcrumb: "සෞඛ්‍ය ලේඛන",

    form: {
      addNewRecord: "නව ලේඛනයක් එක් කරන්න",
      editRecord: "වාර්තාව සංස්කරණය කරන්න",
      recordName: "ලේඛන නම",
      recordNamePlaceholder: "උදා. වසරකට වරක් රුධිර පරීක්ෂණය",
      recordNameRequired: "ලේඛන නම අවශ්‍යයි.",
      date: "දිනය",
      dateRequired: "දිනය අවශ්‍යයි.",
      description: "විස්තරය",
      descriptionOptional: "විකල්ප",
      descriptionPlaceholder: "මෙම ලේඛනය පිළිබඳ සටහන් හෝ විස්තර එක් කරන්න...",
