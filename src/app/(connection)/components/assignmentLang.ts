...
export const assignmentTranslations: Record<LanguageCode, AssignmentTranslations> = {
  ...
  si: {
    ...
    roleLabels: {
      ...
      HOPE_TO_PREGNANT_MOTHER: "ගැබ් ගැනීම අපේක්ෂා කරන මව",
    },
    header: {
    ...
    messages: {
      ...
      requestApproved: "ඉල්ලීම නිවැරදිව අනුමත කරන ලදි.",
      requestRejected: "ඉල්ලීම නිවැරදිව ප්‍රතික්ෂේප කරන ලදි.",
      requestCancelled: "ඉල්ලීම නිවැරදිව අවලංගු කරන ලදි.",
      assignedMidwifeCancelled: "පවරා ඇති පවුල් සෞඛ්‍ය සේවිකාව නිවැරදිව අවලංගු කරන ලදි.",
      assignedMotherCancelled: "පවරා ඇති මව නිවැරදිව අවලංගු කරන ලදි.",
      assignedUserUpdated: "පවරා ඇති පරිශීලකයාගේ පැතිකඩ නිවැරදිව යාවත්කාලීන කරන ලදි.",
      createdRequests: (count) => `ඉල්ලීම් ${count}ක් නිවැරදිව සාදන ලදි.`,
