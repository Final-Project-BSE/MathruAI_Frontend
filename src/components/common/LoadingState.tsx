...
export function LoadingState() {
  return (
    <div className="min-h-screen bg-[#fed2cc] p-6 flex items-center justify-center">
      <Card className="bg-white/90 backdrop-blur-sm p-6">
        <div className="flex flex-col items-center gap-4">
          <div className="relative w-24 h-24">
            <div className="absolute inset-0 rounded-full border-4 border-pink-200 border-t-[#d04f51] animate-spin" />
