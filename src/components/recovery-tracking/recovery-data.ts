...
// Generator for 42 days of advice
export const getRecoveryData = (): DayAdvice[] => {
  ...
  for (let day = 1; day <= 42; day++) {
    ...
    physicalTasks.forEach((t, i) => tasks.push({ id: genId(day, "phys", i), category: "physical", text: t }));
    ...
    if (day <= 21) {
      nutritionTasks.push("Take prescribed supplements (iron, calcium, vitamins)");
      nutritionTasks.push("Include iron-rich foods (green leaves, dates)");
    } else {
      nutritionTasks.push("Continue prenatal vitamins if advised");
    }

    nutritionTasks.forEach((t, i) => tasks.push({ id: genId(day, "nutr", i), category: "nutrition", text: t }));
    ...
    babyTasks.forEach((t, i) => tasks.push({ id: genId(day, "baby", i), category: "baby", text: t }));
    ...
    mentalTasks.forEach((t, i) => tasks.push({ id: genId(day, "ment", i), category: "mental", text: t }));
    ...
    medicalTasks.forEach((t, i) => tasks.push({ id: genId(day, "med", i), category: "medical", text: t }));
    ...
    warningTasks.forEach((t, i) => tasks.push({ id: genId(day, "warn", i), category: "warning", text: t, isWarning: true }));

    // Advice logic
    let adviceText = "Focus on resting and bonding with your baby today. Listen to your body and don't hesitate to ask for help.";
    if (day === 1) adviceText = "Welcome to Day 1! The most important thing today is resting and recovering from birth. Keep your baby close and ask for help whenever needed.";
    else if (day === 7) adviceText = "You've made it through the first week! It's normal to feel emotional as your hormones adjust. Continue taking things very slowly.";
    else if (day === 14) adviceText = "Two weeks postpartum. You might be feeling a bit more mobile, but remember you are still actively healing. Don't push yourself.";
    else if (day === 21) adviceText = "Week three! Bleeding should be much lighter now. Continue to prioritize hydration and nutrition to support your recovery.";
    else if (day === 28) adviceText = "Four weeks! You are over halfway through the traditional 6-week recovery period. You might consider adding slightly longer walks if cleared by your doctor.";
    else if (day === 42) adviceText = "Day 42 marks the end of the initial 6-week postpartum period. Celebrate your journey and attend your final postnatal checkup!";
