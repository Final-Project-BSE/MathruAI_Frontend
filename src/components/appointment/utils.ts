...
export type AppointmentTheme = "light" | "dark";
...
export function getAppointmentThemeFromRoles(roles?: Role[] | null): AppointmentTheme {
  return roles && hasMidwifeRole(roles) ? "dark" : "light";
}
