...
export const ROUTE_ACCESS: Record<string, UserRole[]> = {
  ...
  '/health-monitoring': [ROLES.HOPE_TO_PREGNANT_MOTHER, ROLES.PREGNANT_MOTHER, ROLES.MIDWIFE],
  '/daily-recommendations': [ROLES.PREGNANT_MOTHER, ROLES.MIDWIFE],
  '/midwife-connection': [ROLES.HOPE_TO_PREGNANT_MOTHER, ROLES.PREGNANT_MOTHER, ROLES.MIDWIFE],
  '/chatbot': [ROLES.HOPE_TO_PREGNANT_MOTHER, ROLES.PREGNANT_MOTHER, ROLES.MIDWIFE],
  ...
  '/healthrecords': [ROLES.HOPE_TO_PREGNANT_MOTHER, ROLES.PREGNANT_MOTHER, ROLES.MIDWIFE],
  '/timeline-milestone': [ROLES.HOPE_TO_PREGNANT_MOTHER, ROLES.PREGNANT_MOTHER, ROLES.MIDWIFE],
  '/nutrition-wellness': [ROLES.HOPE_TO_PREGNANT_MOTHER, ROLES.PREGNANT_MOTHER, ROLES.MIDWIFE],
