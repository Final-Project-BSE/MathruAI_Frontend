...
export const ROUTE_ACCESS: Record<string, UserRole[]> = {
  ...
  '/health-monitoring': [ROLES.HOPE_TO_PREGNANT_MOTHER, ROLES.MIDWIFE, ROLES.PREGNANT_MOTHER, ROLES.POST_PREGNANT_MOTHER],
  ...
  '/chatbot': [ROLES.HOPE_TO_PREGNANT_MOTHER, ROLES.MIDWIFE, ROLES.PREGNANT_MOTHER, ROLES.POST_PREGNANT_MOTHER],
  '/notifications': [ROLES.HOPE_TO_PREGNANT_MOTHER, ROLES.MIDWIFE, ROLES.POST_PREGNANT_MOTHER],
  '/announcement': [ROLES.HOPE_TO_PREGNANT_MOTHER, ROLES.PREGNANT_MOTHER, ROLES.MIDWIFE, ROLES.POST_PREGNANT_MOTHER],
  ...
  '/midwife/vaccinations': [ROLES.MIDWIFE],
  '/midwife/checklist': [ROLES.MIDWIFE],
  '/midwife/profile': [ROLES.MIDWIFE],
